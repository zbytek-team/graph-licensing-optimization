...
Dla potrzeb jednolitego formalnego opisu w pracy stosowane są wymiennie pojęcia \textbf{konfiguracja licencyjna}, \textbf{wariant licencyjny} oraz \textbf{schemat licencjonowania}, które odnoszą się do konkretnego zbioru typów licencji definiowanego przez $\mathcal{L}$. Na przykład Duolingo Super stanowi schemat licencjonowania składający się z dwóch typów licencji: indywidualnej oraz rodzinnej. Analogicznie, dla celów teoretycznych, dominowanie rzymskie traktowane jest jako schemat licencjonowania zawierający licencję indywidualną i grupową. Takie podejście umożliwia sprowadzenie różnych modeli licencjonowania do jednej spójnej abstrakcji matematycznej i ułatwia porównanie wyników między wariantami rzeczywistymi a teoretycznymi.
