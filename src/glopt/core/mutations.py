...
class MutationOperators:
    ...
    def reassign_member(
        ...
        receivers = [
            g for g in solution.groups if g.size < g.license_type.max_capacity
        ]
    ...
    def split_group(
        ...
        for _ in range(4):
            ...
            compat1 = SolutionBuilder.get_compatible_license_types(
                len(part1), license_types
            )
            compat2 = SolutionBuilder.get_compatible_license_types(
                len(part2), license_types
            )
