...
class AntColonySolver(BaseStaticSolver):
    ...
    def _make_solution(self, graph: nx.Graph) -> tuple[Assignment, list]:
        alpha = self.alpha
        beta = self.beta
    ...
    def _deposit_pheromones(self, solutions: list[tuple[Assignment, float]], node_orders: list[list]) -> None:
    ...
    def _update_pheromones(self, solutions: list[tuple[Assignment, float]], node_orders: list[list]) -> None:
